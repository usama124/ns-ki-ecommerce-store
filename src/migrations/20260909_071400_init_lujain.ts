...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_categories_type" AS ENUM('main', 'subcategory');
  CREATE TYPE "public"."enum_products_variants_size" AS ENUM('XS', 'S', 'M', 'L', 'XL', 'Unstitched');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending_verification', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled');
  CREATE TYPE "public"."enum_orders_payment_method" AS ENUM('cod', 'bank_transfer', 'jazzcash', 'easypaisa');
  CREATE TYPE "public"."enum_forms_confirmation_type" AS ENUM('message', 'redirect');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_homepage_hero_slider_media_type" AS ENUM('image', 'video');
  ...
  CREATE TABLE "categories" (
  	...
  	"slug" varchar,
  	"type" "enum_categories_type" DEFAULT 'main' NOT NULL,
  	"parent_id" integer,
  ...
  CREATE TABLE "products_variants" (
  	...
  	"sku" varchar,
  	"stock" numeric DEFAULT 10 NOT NULL,
  	"price_p_k_r" numeric
  );
  ...
  CREATE TABLE "products" (
  	...
  	"base_price_p_k_r" numeric NOT NULL,
  	"description" jsonb,
  ...
  CREATE TABLE "orders" (
  	...
  	"status" "enum_orders_status" DEFAULT 'pending_verification',
  	...
  	"payment_proof_transaction_id" varchar,
  	"payment_proof_screenshot_id" integer,
  ...
  CREATE TABLE "homepage_hero_slider" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_type" "enum_homepage_hero_slider_media_type" DEFAULT 'image',
  	"desktop_media_id" integer NOT NULL,
  ...
  CREATE TABLE "homepage_shoppable_videos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "homepage" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"featured_section_title" varchar DEFAULT 'Featured Collection',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "site_settings_shipping_major_cities" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"announcement_bar_is_active" boolean DEFAULT true,
  	"announcement_bar_text" varchar DEFAULT 'FREE EXPRESS SHIPPING ACROSS PAKISTAN ON ORDERS ABOVE RS. 15,000',
  	"announcement_bar_link" varchar,
  	"shipping_free_shipping_threshold" numeric DEFAULT 15000,
  	"shipping_major_city_fee" numeric DEFAULT 250,
  	"shipping_secondary_city_fee" numeric DEFAULT 350,
  	"payment_details_bank_transfer_bank_name" varchar DEFAULT 'Meezan Bank',
  	"payment_details_bank_transfer_account_title" varchar DEFAULT 'LUJAIN LUXURY FASHION',
  	"payment_details_bank_transfer_account_number" varchar DEFAULT 'PK00MEZN0001020304050607',
  	"payment_details_bank_transfer_raast_id" varchar DEFAULT '03001234567',
  	"payment_details_jazzcash_mobile_number" varchar DEFAULT '03001234567',
  	"payment_details_jazzcash_account_name" varchar DEFAULT 'LUJAIN CLOTHING',
  	"payment_details_easypaisa_mobile_number" varchar DEFAULT '03001234567',
  	"payment_details_easypaisa_account_name" varchar DEFAULT 'LUJAIN CLOTHING',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "products" ADD CONSTRAINT "products_main_category_id_categories_id_fk" FOREIGN KEY ("main_category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products" ADD CONSTRAINT "products_product_video_id_media_id_fk" FOREIGN KEY ("product_video_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "orders" ADD CONSTRAINT "orders_payment_proof_screenshot_id_media_id_fk" FOREIGN KEY ("payment_proof_screenshot_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "homepage_hero_slider" ADD CONSTRAINT "homepage_hero_slider_desktop_media_id_media_id_fk" FOREIGN KEY ("desktop_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "homepage_hero_slider" ADD CONSTRAINT "homepage_hero_slider_mobile_media_id_media_id_fk" FOREIGN KEY ("mobile_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "homepage_hero_slider" ADD CONSTRAINT "homepage_hero_slider_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_shoppable_videos" ADD CONSTRAINT "homepage_shoppable_videos_video_id_media_id_fk" FOREIGN KEY ("video_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "homepage_shoppable_videos" ADD CONSTRAINT "homepage_shoppable_videos_poster_id_media_id_fk" FOREIGN KEY ("poster_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "homepage_shoppable_videos" ADD CONSTRAINT "homepage_shoppable_videos_linked_product_id_products_id_fk" FOREIGN KEY ("linked_product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "homepage_shoppable_videos" ADD CONSTRAINT "homepage_shoppable_videos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_settings_shipping_major_cities" ADD CONSTRAINT "site_settings_shipping_major_cities_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "products_main_category_idx" ON "products" USING btree ("main_category_id");
  CREATE INDEX "products_product_video_idx" ON "products" USING btree ("product_video_id");
  ...
  CREATE INDEX "orders_payment_proof_payment_proof_screenshot_idx" ON "orders" USING btree ("payment_proof_screenshot_id");
  ...
  CREATE INDEX "homepage_hero_slider_order_idx" ON "homepage_hero_slider" USING btree ("_order");
  CREATE INDEX "homepage_hero_slider_parent_id_idx" ON "homepage_hero_slider" USING btree ("_parent_id");
  CREATE INDEX "homepage_hero_slider_desktop_media_idx" ON "homepage_hero_slider" USING btree ("desktop_media_id");
  CREATE INDEX "homepage_hero_slider_mobile_media_idx" ON "homepage_hero_slider" USING btree ("mobile_media_id");
  CREATE INDEX "homepage_shoppable_videos_order_idx" ON "homepage_shoppable_videos" USING btree ("_order");
  CREATE INDEX "homepage_shoppable_videos_parent_id_idx" ON "homepage_shoppable_videos" USING btree ("_parent_id");
  CREATE INDEX "homepage_shoppable_videos_video_idx" ON "homepage_shoppable_videos" USING btree ("video_id");
  CREATE INDEX "homepage_shoppable_videos_poster_idx" ON "homepage_shoppable_videos" USING btree ("poster_id");
  CREATE INDEX "homepage_shoppable_videos_linked_product_idx" ON "homepage_shoppable_videos" USING btree ("linked_product_id");
  CREATE INDEX "site_settings_shipping_major_cities_order_idx" ON "site_settings_shipping_major_cities" USING btree ("_order");
  CREATE INDEX "site_settings_shipping_major_cities_parent_id_idx" ON "site_settings_shipping_major_cities" USING btree ("_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "homepage_hero_slider" CASCADE;
  DROP TABLE "homepage_shoppable_videos" CASCADE;
  DROP TABLE "homepage" CASCADE;
  DROP TABLE "site_settings_shipping_major_cities" CASCADE;
  ...
  DROP TYPE "public"."enum_homepage_hero_slider_media_type";`)
}
